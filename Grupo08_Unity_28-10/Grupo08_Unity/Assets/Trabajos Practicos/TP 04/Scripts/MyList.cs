...
namespace TP04.Data
{
    public class MyList<T>
    {
        ...
        public T this[int i]
        {
            get { if (i < 0 || i >= _count) throw new IndexOutOfRangeException(); return _items[i]; }
            set { if (i < 0 || i >= _count) throw new IndexOutOfRangeException(); _items[i] = value; }
        }
        ...
        private static void Swap(MyList<T> list, int i, int j)
        {
